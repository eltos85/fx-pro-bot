...
3. **Фильтры (защита от входа не вовремя).** Применяются ТОЛЬКО к контр-трендовым
   фейдам (sweep_fade, density_bounce):
   ...
   У **density_break** трендовых фильтров НЕТ — пробою тренд наоборот нужен
   (кулдаун после SL у него базовый 5 мин).
