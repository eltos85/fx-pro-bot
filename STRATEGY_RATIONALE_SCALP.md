...
5. **Стоп и цель.**
   ...
   - **Цель (TP)** — кратность базового риска (sweep_fade 3.5R, density_break 2.5R).
     Важно: цель считается от *базового* риска и от ширины стопа НЕ зависит.
...
6. **Слежение и закрытие.** У каждой стратегии своя логика выхода:
   ...
   - **density_break** — не вмешиваемся вообще: только биржевой TP 2.5R / SL
