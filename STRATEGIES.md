...
**Порог:** 4 из 5 голосов (`MIN_VOTES = 3` + `MIN_STRENGTH = 0.7` → strength 3/5 = 0.6 < 0.7, нужно ≥ 4)
...
**Сигнал выдаётся** только если 4+ индикаторов согласны по направлению (3/5 = 0.6 не проходит фильтр `MIN_STRENGTH = 0.7`).
