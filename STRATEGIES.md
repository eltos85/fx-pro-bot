...
**Убраны из сканирования:** вся крипта (BTC, ETH, SOL, XRP, DOGE, ADA, LINK, AVAX, LTC, BNB, DOT), ZN=F (0% WR), NQ=F (не найден в cTrader).
...
### Forex (7 пар + NZD для скальпинга)
...
> **Примечание:** Крипта (BTC, ETH, альткоины) полностью убрана из FxPro advisor с 12.04.2026.
> Причина: отрицательный P&L по всем крипто-инструментам, проблемы с SL на cTrader для альткоинов,
> высокие спреды. Крипта торгуется отдельно через Bybit-бот.
