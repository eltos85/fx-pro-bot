...
**Outsiders/ensemble — только USDJPY.** Анализ 48ч (14–16.04.2026) показал: outsiders убыточен на 4 из 5 пар (WR 16–22%, net -$30). Единственный прибыльный символ — USDJPY (WR 64%, net +$2.95). Белый список `OUTSIDERS_ALLOW_SYMBOLS = {"USDJPY=X"}`.
