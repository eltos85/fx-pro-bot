"""Тесты технических индикаторов FX AI Trader.
...
плюс известные edge-кейсы. (Логика перенесена из удалённого ai_trader,
теперь живёт изолированно в fx_ai_trader.)
"""
...
class TestSnapshot:
    ...
    def test_format_snapshot_with_full_data_shows_labels(self):
        ...
        # bug-fix RSI extreme thresholds; раньше был просто [OVERBOUGHT].
