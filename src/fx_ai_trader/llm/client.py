"""DeepSeek-V4 клиент для FX AI Trader (Anthropic-compatible API).

Используем `anthropic` SDK с переопределённым base_url, как описано в
https://api-docs.deepseek.com/guides/anthropic_api

Возвращаем сырой текст ответа + использованные токены. Парсинг JSON живёт в
trading/executor.py. Изолированная копия внутри fx_ai_trader (ранее
переиспользовалась из удалённого ai_trader; теперь живёт здесь).
"""
