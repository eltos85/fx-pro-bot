...
``FLOWZONE_SESSION_WINDOWS_UTC``.

2026-08-17: дефолт временно возвращён к London+NY ``07:00-16:00,12:00-21:00``
(изоляция ядра vs C4). Канон-окно C4 ``12:00-21:00`` включается тем же env.
Функции чистые, тестируются на фикстурах.
"""
