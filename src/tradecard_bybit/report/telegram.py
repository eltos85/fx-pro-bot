"""Лёгкий Telegram-нотификатор tradecard (только исходящие, без поллинга).

Инлайн-копия паттерна scalp_bot/telegram/notifier.py (read-only-инфраструктура,
без кросс-зависимости — TASKSPEC §9). No-op если выключен/нет token/chat_id.
...
log = logging.getLogger("tradecard_bybit.tg")
