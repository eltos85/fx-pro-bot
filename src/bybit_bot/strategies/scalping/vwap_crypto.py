...
class VwapCryptoStrategy:
    ...
    Фильтр: ADX ≤ ``ADX_MAX`` (см. константу модуля; текущее значение 25,
    приведено в соответствие с реально работающим кодом — AUDIT_2026.md
    P0 fix), RSI подтверждение, EMA slope.
