...
- Маркируют все наши ордера ``label="ai-fx-trend"`` для broker-side
...
from fx_ai_trend.trading.token_lock import (
...
class CTraderFxAdapter:
    ...
    def __init__(self, settings: AiFxTrendSettings) -> None:
    ...
    def get_open_positions(self) -> list[BrokerPosition] | None:
        """Возвращает наши открытые позиции (label = "ai-fx-trend").
    ...
    def place_market_order(
        ...
        *,
        ...
        """Market-ордер с label="ai-fx-trend".
