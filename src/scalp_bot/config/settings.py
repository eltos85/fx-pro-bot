...
class ScalpSettings(BaseSettings):
    ...
    # sweep_fade_trend (v0.18.27) УДАЛЕНА v0.18.33 (2026-07-06, решение
    # пользователя): форвард n=35 WR 37% net −$121.62, гипотеза range-day-fade
    # опровергнута; run перспективнее (R:R 2.4:1, breakeven-WR 30% vs 46%).
    # Числа — BUILDLOG_SCALP 2026-07-06.
